...
#create a function to load teh dataset
def load_data():
...
# create a title for teh app
st.title("SuperMarket Sales Analysis")

#add a filter
filters = {"Gender": data["Gender"].unique(),
...
# calsculate total revenue, total quantity, avg unitprive, avg tax
...
# find the product line with the highesr revenue
# use
